                ...
                <div class="card-body p-4">
                    <form action="{{ route('contents.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            {{-- Is Premium (is_premium field from your DB) --}}
                            <div class="col-md-3 mb-3">
                            ...
                            {{-- Thumbnail Upload (thumbnail field from your DB) --}}
                            <div class="col-md-12 mb-4">
                                ...
                                <div class="d-flex align-items-start gap-3 border p-3 rounded bg-light">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <small class="text-muted d-block">Recommended size: 600x400px. JPG, PNG, WEBP.</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="border-top pt-4">
                            <button type="submit" class="btn btn-primary px-4 shadow-sm">
                                <i class="bi bi-cloud-arrow-up me-1"></i> Save Content
                            </button>
