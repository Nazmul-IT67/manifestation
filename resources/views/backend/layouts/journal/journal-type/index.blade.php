@extends('backend.app')
@section('page_title', 'Journal Management')
            ...
            <div class="col-md-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3 d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Journal Types</h5>
                    </div>
                    <div class="card-body">
                        <table class="table table-hover table-bordered w-100" id="journal-type-table">
